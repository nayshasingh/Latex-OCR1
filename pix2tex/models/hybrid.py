...
from timm.models.swin_transformer import SwinTransformer  # Import Swin Transformer
...
class CustomSwinTransformer(SwinTransformer):
    def __init__(self, img_size=224, patch_size=16, *args, **kwargs):
        super(CustomSwinTransformer, self).__init__(img_size=img_size, patch_size=patch_size, *args, **kwargs)
...
def get_encoder(args):
    ...
    encoder = CustomSwinTransformer(img_size=(args.max_height, args.max_width),
